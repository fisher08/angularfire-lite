...
var AngularFireLiteApp = (function () {
    ...
    AngularFireLiteApp.prototype.instance = function () {
        var firebaseApp;
        if (!apps.length) {
            firebaseApp = (initializeApp(this.appConfig));
        }
        else {
            firebaseApp = app();
        }
...
var AngularFireLiteAuth = (function () {
    function AngularFireLiteAuth(app$$1, http, platformId) {
        this.app = app$$1;
        this.http = http;
    ...
    AngularFireLiteAuth.prototype.isAuthenticated = function () {
        var IS_AUTHENTICATED = new Subject();
    ...
    AngularFireLiteAuth.prototype.userData = function () {
        ...
        if (this.server) {
            ...
            return fromPromise(this.auth.currentUser.getIdToken(true).then(function (idToken) {
...
var AngularFireLiteDatabase = (function () {
    function AngularFireLiteDatabase(app$$1, http, state, platformId) {
        var _this = this;
        this.app = app$$1;
        this.http = http;
        this.state = state;
    ...
    AngularFireLiteDatabase.prototype.BRH = function (ref, event, DSK) {
        if (this.browser) {
            ...
            var DATA_1 = new BehaviorSubject(SSRedValue);
        ...
        return {
            ...
            on: function (event) {
                ...
                if (isPlatformBrowser(PID)) {
                    ...
                    var VALUE = new BehaviorSubject(SSRedValue);
...
var AngularFireLiteFirestore = (function () {
    function AngularFireLiteFirestore(app$$1, http, state, platformId) {
        this.app = app$$1;
        this.http = http;
        this.state = state;
        this.platformId = platformId;
        ...
        if (this.browser) {
            ...
            if (slashes % 2 === 0) {
                ...
                this.firestore.doc(ref).onSnapshot(function (snapshot) {
                    DATA_2.next(Object.assign({}, snapshot.data(), { $key: snapshot.id }));
                });
            }
            return DATA_2;
        }
    ...
    AngularFireLiteFirestore.prototype.removeCollection = function (collectionRef) {
        var _this = this;
        if (this.browser) {
            return fromPromise(this.firestore.collection(collectionRef).get().then(function (snapshot) {
                snapshot.docs.forEach(function (doc) {
    ...
    AngularFireLiteFirestore.prototype.query = function (ref) {
        ...
        return {
            ...
            on: function () {
                var ONDSK = makeStateKey(ref + ':query');
                if (isPlatformServer(PID)) {
                    return SQHFS(ONDSK);
                }
                if (isPlatformBrowser(PID)) {
                    var SSRedValue = state.get(ONDSK, []);
                    var VALUE_1 = new BehaviorSubject(SSRedValue);
            ...
            get: function () {
                var GETDSK = makeStateKey(ref + ':query');
                if (isPlatformServer(PID)) {
                    return SQHFS(GETDSK);
                }
                if (isPlatformBrowser(PID)) {
    ...
    AngularFireLiteFirestore.prototype.transaction = function () {
        if (this.browser) {
            ...
            return {
                ...
                run: function () {
                    return fromPromise(fs_1.runTransaction(function () {
...
var AngularFireLiteStorage = (function () {
...
var AngularFireLiteMessaging = (function () {
    ...
    AngularFireLiteMessaging.prototype.tokenRefresh = function () {
        var _this = this;
        if (this.browser) {
            var REFRESH_TOKEN_1 = new Subject();
...
var FirebaseAppConfig = (function () {
    function FirebaseAppConfig() {
    }
    return FirebaseAppConfig;
}());
var AngularFireLite = (function () {
...
AngularFireLite.ctorParameters = function () { return []; };
