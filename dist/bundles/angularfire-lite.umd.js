(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('firebase'), require('@angular/common/http'), require('rxjs/Subject'), require('rxjs/Observable'), require('rxjs/observable/fromPromise'), require('@angular/common'), require('rxjs/add/observable/of'), require('rxjs/BehaviorSubject'), require('@angular/platform-browser'), require('rxjs/add/operator/map'), require('rxjs/add/operator/do'), require('firebase/firestore')) :
	typeof define === 'function' && define.amd ? define('angularfire-lite', ['exports', '@angular/core', 'firebase', '@angular/common/http', 'rxjs/Subject', 'rxjs/Observable', 'rxjs/observable/fromPromise', '@angular/common', 'rxjs/add/observable/of', 'rxjs/BehaviorSubject', '@angular/platform-browser', 'rxjs/add/operator/map', 'rxjs/add/operator/do', 'firebase/firestore'], factory) :
	(factory((global['angularfire-lite'] = {}),global.ng.core,global.firebase,global.ng.common.http,global.Rx,global.Rx,global.Rx.Observable,global.ng.common,global.Rx.Observable,global.Rx,global.ng.platformBrowser));
}(this, (function (exports,core,firebase,http,Subject,Observable,fromPromise,common,of,BehaviorSubject,platformBrowser) { 'use strict';
